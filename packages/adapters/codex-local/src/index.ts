...
export const models = [
  ...
  { id: DEFAULT_CODEX_LOCAL_MODEL, label: "GPT-5.6-Luna" },
...
export const modelProfiles: AdapterModelProfileDefinition[] = [
  {
    key: "cheap",
    label: "Cheap",
    description: "Use the account-supported Codex default model for automatic continuation runs.",
    adapterConfig: {
...
- Paperclip injects run-scoped HTTP MCP servers (including GitHub, Google Workspace, and Meta Ads when configured) through Codex's native mcp_servers overrides. Bearer tokens are passed only through the child process environment.
