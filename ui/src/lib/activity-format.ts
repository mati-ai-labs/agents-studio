...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "issue.slack_completion_posted": "posted Slack completion for",
  "issue.slack_completion_failed": "failed Slack completion for",
...
const ISSUE_ACTIVITY_LABELS: Record<string, string> = {
  ...
  "issue.slack_completion_posted": "posted a Slack completion update",
  "issue.slack_completion_failed": "Slack completion delivery failed",
