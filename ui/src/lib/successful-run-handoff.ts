...
export const SUCCESSFUL_RUN_HANDOFF_REQUIRED_NOTICE_BODY =
  "Agent Studio needs a disposition before this issue can continue.";
export const SUCCESSFUL_RUN_HANDOFF_EXHAUSTED_NOTICE_BODY =
  "Agent Studio could not resolve this issue's missing disposition automatically. The issue is blocked on a recovery owner.";
