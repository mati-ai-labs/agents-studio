...
function mapInviteAuthFeedback(
  ...
  if (code === "INVALID_EMAIL_OR_PASSWORD") {
    return {
      tone: "error",
      message:
        "That email and password did not match an existing Agent Studio account. Check both fields, or create an account first if you are new here.",
    };
  }
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0">
                ...
                <h1 className="mt-2 text-2xl font-semibold">
                  {invite.inviteType === "bootstrap_ceo" ? "Set up Agent Studio" : `Join ${companyDisplayName}`}
                </h1>
                <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-300">
                  {showsAgentForm
                    ...
                    : requiresHumanAccount
                      ? "Create your Agent Studio account first. If you already have one, switch to sign in and continue the invite with the same email."
            ...
            {showsAgentForm ? (
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <p className="mt-1 text-sm text-zinc-400">
                    {authMode === "sign_up"
                      ? `Start with an Agent Studio account. After that, you'll come right back here to accept the invite for ${companyDisplayName}.`
