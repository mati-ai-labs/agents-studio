  ...
  return (
    <>
      ...
      <div className="flex items-start gap-4">
        ...
        />
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-(--tracking-caps) text-zinc-500">You&apos;ve been invited to join Agent Studio</p>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">
          {mode === "sign_up"
            ? "Start with an Agent Studio account. After that, you'll come right back here to accept the invite for Acme Robotics."
            : "Use the Agent Studio account that already matches this invite. If you do not have one yet, switch back to create account."}
        </p>
      </div>
      ...
      <p className="text-xs leading-5 text-zinc-500">
        {mode === "sign_up"
          ? "Already signed up before? Use the existing-account option instead so the invite lands on the right Agent Studio user."
        ...
        <div className="flex min-h-(--sz-420px) flex-col justify-center bg-background px-8 py-10">
          <div className="mx-auto w-full max-w-md">
            ...
            <h3 className="text-xl font-semibold">
              {mode === "sign_in" ? "Sign in to Agent Studio" : "Create your Agent Studio account"}
            </h3>
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  This URL includes the current Agent Studio domain returned by the server.
                </div>
              </div>
          ...
          <InviteLandingShell
            left={
              <InviteSummaryPanel
                ...
                description="Create your Agent Studio account first. If you already have one, switch to sign in and continue the invite with the same email."
