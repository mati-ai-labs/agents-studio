...
const EXECUTION_WORKSPACE_BASE_TAB_ITEMS: OrderedExecutionWorkspaceTabItem[] = [
  ...
  { value: "routines", label: "Workflows", order: 60 },
];
  ...
  const runRoutine = useMutation({
    ...
    onSuccess: async (_, { id }) => {
      ...
      pushToast({
        ...
        body: "Agent Studio created a run using this execution workspace.",
        tone: "success",
      });
    },
    onSettled: () => {
            ...
            <Card className="rounded-none">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Field label="Provision command" hint="Runs when Agent Studio prepares this execution workspace">
                    <Textarea
